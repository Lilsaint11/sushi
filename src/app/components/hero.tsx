...
const Hero = () => {
    return ( 
        <div className="flex">
            <div>
                <h1 className="text-[60px] font-bold leading-tight mb-10">Sushi Bliss, Every Roll a Flavorful <span className="text-[#39DB4A]">Kiss</span> </h1>
            ...
            <div className="relative">
                <img src="/Group 33.png" alt="" className="w-64 absolute -top-11 -left-20" />
                <img src="/MAIN SUSHI IMAGE.png" alt=""className="-mt-20"/>
